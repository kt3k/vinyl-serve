...
const VinylServer = require('./VinylServer')
...
const createServer = port => {
    ...
    const server = new VinylServer(port)
    server.start()
...
module.exports.setHandlerOfPortError = handler => VinylServer.setHandlerOfPortError(handler)

module.exports.setHandlerOfStarting = handler => VinylServer.setHandlerOfStarting(handler)
