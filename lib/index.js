...
exports.setDebugPagePath = function (path) {

    VinylServer.setDebugPagePath(path)

}

exports.setHandlerOfPortError = function (handler) {

    VinylServer.setHandlerOfPortError(handler)

}

exports.setHandlerOfStarting = function (handler) {
